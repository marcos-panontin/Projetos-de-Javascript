...
let valorApostadoEl = document.getElementById("apostado-el")
...
function startGame() {
  ...
  inputAposta = "0";
  valorApostadoEl.textContent = `Você apostou US$ ${inputAposta}`
...
function fazerAposta(){
  var inputAposta = document.getElementById("aposta-input").value;
  valorApostadoEl.textContent = `Você apostou US$ ${inputAposta}`
  player.chips = player.chips - inputAposta
  playerEl.textContent = player.name + " US$: " + player.chips;
}
